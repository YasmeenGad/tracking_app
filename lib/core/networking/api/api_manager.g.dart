...
class _ApiManager implements ApiManager {
  ...
  Future<ApplyResponseDto> applyDriver(
    ...
    _data.fields.add(MapEntry('vehicleType', vechicleType));
    _data.fields.add(MapEntry('vehicleNumber', vechicleNumber));
    _data.files.add(
      MapEntry(
        'vehicleLicense',
  ...
  Future<GetLoggedDriverDataResponseDto> getLoggedDriverData() async {
    ...
    final _options = _setStreamType<GetLoggedDriverDataResponseDto>(
  ...
  Future<GetAllVehiclesDto> getAllVehicles() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllVehiclesDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/v1/vehicles',
  ...
  Future<PendingOrderResponseDto> getPendingOrders(int limit) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PendingOrderResponseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PendingOrderResponseDto _value;
    try {
      _value = PendingOrderResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<DriverOrderResponseDto> getDriverOrders(int limit) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'limit': limit};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DriverOrderResponseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/v1/orders/driver-orders/',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DriverOrderResponseDto _value;
    try {
      _value = DriverOrderResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> changeOrderStatus(String id, ChangeOrderStateDto state) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
